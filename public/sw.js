const CACHE="suno-apothecary-v1";
self.addEventListener("install",event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(["/","/manifest.webmanifest","/icons/apothecary.svg","/assets/apothecary-goddess.webp"]))));
